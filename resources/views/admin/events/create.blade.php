                ...
                <div class="p-8">
                    <form action="{{ route('admin.events.store') }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title') }}" required class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="Masukkan judul event...">
                            @error('title')
                        ...
                        <div>
                            ...
                            <input type="datetime-local" name="event_date" id="event_date" value="{{ old('event_date') }}" required class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                            @error('event_date')
                                <p class="text-sm text-red-650 mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="6" required class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" placeholder="Tuliskan deskripsi lengkap event di sini...">{{ old('description') }}</textarea>
                            @error('description')
                                <p class="text-sm text-red-650 mt-1">{{ $message }}</p>
                            @enderror
                        </div>
